...
namespace Tests.PlayMode
{
    ...
    public class EmojiTest
    {
        ...
        private IEnumerator MoveToEmoji()
        {
            ...
            // ReSharper disable once Unity.InefficientPropertyAccess
            AssertVectors(_scoreArea.GetComponent<ScoreArea>().GetPositionOfStoneChild(_currentStone),
                _currentStone.transform.position, $"Player {_currentPlayer}: Wrong stone position");
